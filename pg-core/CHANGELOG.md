...
## [0.6.10](https://github.com/encryption4all/postguard/compare/pg-core-v0.6.9...pg-core-v0.6.10) - 2026-09-24

### Added

- add postguard's renovate.json, pin-ignore pg-compat's readers ([#457](https://github.com/encryption4all/postguard/pull/457))
- check the map body's two stated budgets ([#452](https://github.com/encryption4all/postguard/pull/452))

### Other

- *(ci)* pin WASM_BINDGEN_TEST_TIMEOUT to 70 in ci_wiring ([#456](https://github.com/encryption4all/postguard/pull/456))

## [0.6.9](https://github.com/encryption4all/postguard/compare/pg-core-v0.6.8...pg-core-v0.6.9) - 2026-09-22

### Other

- file an issue when the ruleset-drift gate detects drift ([#443](https://github.com/encryption4all/postguard/pull/443))
