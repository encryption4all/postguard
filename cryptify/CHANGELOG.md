...
## [0.1.39](https://github.com/encryption4all/postguard/compare/cryptify-v0.1.38...cryptify-v0.1.39) - 2026-09-10

### Other

- updated the following local packages: pg-core, pg-core

## [0.1.38](https://github.com/encryption4all/postguard/compare/cryptify-v0.1.37...cryptify-v0.1.38) - 2026-09-07
...
- *(cryptify)* flush a chunk to disk before its PUT is acknowledged ([#408](https://github.com/encryption4all/postguard/pull/408))
...
- *(cryptify)* stop the finalize 413 from leaking a claimed sender's usage ([#404](https://github.com/encryption4all/postguard/pull/404))
